...
if selected == 'Data Analysis':
	...
	col5.markdown('This scatter plot shows the relation between values from 3 axes: \'Life Ladder\', \'Log GDP per capita\' and \'Generosity\', with each dot representing one country and its happiness status in the year 2021. The colors are attributed according to the region to which the country belongs, helping visualize and differenciate the distribution of happiness levels in various regions.')
